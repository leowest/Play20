...
object PlayBuild extends Build {
    ...
    object BuildSettings {
        ...
        val buildVersion      = Option(System.getProperty("play.version")).filterNot(_.isEmpty).getOrElse{
          System.err.println("play.version is not set, use -Dplay.version=<version>")
          System.exit(-1)
          "2.0-unknown"
        }
